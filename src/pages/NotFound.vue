<template>
    <div>
        ...
        <header v-if="!$root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            ...
            >
                <img class="bi me-2 ms-4" width="40" height="40" src="/icon-192x192.png" alt="IssueLab" />
                <span class="fs-4 title">IssueLab Status</span>
            </router-link>
        </header>
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                <img class="bi" width="40" height="40" src="/icon-192x192.png" alt="IssueLab" />
                <span class="fs-4 title ms-2">IssueLab Status</span>
            </router-link>
        </header>
